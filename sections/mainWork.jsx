      ...
      >
        <div style={styles.contentWrapperStyle} className="work__main-work-1">
          <div style={styles.logoContainerStyle}>
            ...
            >
              <img src='images/work/cbs-logo.png' style={styles.logoStyle} alt="CBS Interactive" />
            </a>
          </div>
        ...
        <div style={styles.contentWrapperStyle} className="work__main-work-1">
          <div style={styles.logoContainerStyle}>
            <a
              ...
              style={{ width: '100%' }}
            >
              <img src='images/work/envivent.svg' style={styles.logoStyle} alt="Envivent Web Development" />
            </a>
          </div>
          <div style={styles.textContainerStyle}>
